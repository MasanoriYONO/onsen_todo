...
var TodoList = (function() {
    ...
    TodoList.prototype.load = function() {
        ...
        for(var i = 0 ; i < array_todo.length; i++){
            // if(array_todo[i].description.length > 20){
            //     var t_desc = array_todo[i].description.slice(0,20) + "...";
            // }else{
                var t_desc = array_todo[i].description;
            // }
            ...
            todo_str += '<ons-list-item modifier="chevron" ' + 
                ...
                '<ons-col width="0px" class="col ons-col-inner" style="-webkit-box-flex: 0; flex: 0 0 0px; max-width: 0px;">' +
        ...
        //     $(e.enterPage.element).find(self.listEl).append(todo_str);
        // });
        $(self.listEl).append(todo_str);
    };

    TodoList.prototype.addClickHandler = function() {
    ...
    TodoList.prototype.escape = function(string) {
